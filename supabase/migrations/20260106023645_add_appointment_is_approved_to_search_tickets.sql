-- Add p_appointment_is_approved parameter to search_tickets function
-- This filter was missing after refactoring from the old get_ticket_ids_by_approval_status approach
...
COMMENT ON FUNCTION search_tickets IS 'Comprehensive ticket search with server-side filtering. Includes appointment approval status filter.';
