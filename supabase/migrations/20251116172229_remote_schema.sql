...
-- Create app_configuration policies only if table exists
DO $$ 
BEGIN 
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'app_configuration') THEN
    EXECUTE 'DROP POLICY IF EXISTS "delete_app_config" ON "public"."app_configuration"';
    EXECUTE 'DROP POLICY IF EXISTS "insert_app_config" ON "public"."app_configuration"';
    EXECUTE 'DROP POLICY IF EXISTS "select_app_config" ON "public"."app_configuration"';
    EXECUTE 'DROP POLICY IF EXISTS "update_app_config" ON "public"."app_configuration"';
    EXECUTE 'CREATE POLICY "delete_app_config" ON "public"."app_configuration" AS PERMISSIVE FOR DELETE TO authenticated USING (public.user_has_min_level(2))';
    EXECUTE 'CREATE POLICY "insert_app_config" ON "public"."app_configuration" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (public.user_has_min_level(2))';
    EXECUTE 'CREATE POLICY "select_app_config" ON "public"."app_configuration" AS PERMISSIVE FOR SELECT TO authenticated USING (public.user_has_min_level(0))';
    EXECUTE 'CREATE POLICY "update_app_config" ON "public"."app_configuration" AS PERMISSIVE FOR UPDATE TO authenticated USING (public.user_has_min_level(2)) WITH CHECK (public.user_has_min_level(2))';
  END IF;
END $$;

-- Create appointments policies only if table exists
DO $$ 
BEGIN 
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'appointments') THEN
    EXECUTE 'DROP POLICY IF EXISTS "delete_appointments" ON "public"."appointments"';
    EXECUTE 'DROP POLICY IF EXISTS "insert_appointments" ON "public"."appointments"';
    EXECUTE 'DROP POLICY IF EXISTS "select_appointments" ON "public"."appointments"';
    EXECUTE 'DROP POLICY IF EXISTS "update_appointments" ON "public"."appointments"';
    EXECUTE 'CREATE POLICY "delete_appointments" ON "public"."appointments" AS PERMISSIVE FOR DELETE TO authenticated USING (public.user_has_min_level(1))';
    EXECUTE 'CREATE POLICY "insert_appointments" ON "public"."appointments" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (public.user_has_min_level(1))';
    EXECUTE 'CREATE POLICY "select_appointments" ON "public"."appointments" AS PERMISSIVE FOR SELECT TO authenticated USING (public.user_has_min_level(0))';
    EXECUTE 'CREATE POLICY "update_appointments" ON "public"."appointments" AS PERMISSIVE FOR UPDATE TO authenticated USING (public.user_has_min_level(1)) WITH CHECK (public.user_has_min_level(1))';
  END IF;
END $$;

-- Create companies policies only if table exists
DO $$ 
BEGIN 
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'companies') THEN
    EXECUTE 'DROP POLICY IF EXISTS "delete_companies" ON "public"."companies"';
    EXECUTE 'DROP POLICY IF EXISTS "insert_companies" ON "public"."companies"';
    EXECUTE 'DROP POLICY IF EXISTS "select_companies" ON "public"."companies"';
    EXECUTE 'DROP POLICY IF EXISTS "update_companies" ON "public"."companies"';
    EXECUTE 'CREATE POLICY "delete_companies" ON "public"."companies" AS PERMISSIVE FOR DELETE TO authenticated USING (public.user_has_min_level(1))';
    EXECUTE 'CREATE POLICY "insert_companies" ON "public"."companies" AS PERMISSIVE FOR INSERT TO authenticated WITH CHECK (public.user_has_min_level(1))';
    EXECUTE 'CREATE POLICY "select_companies" ON "public"."companies" AS PERMISSIVE FOR SELECT TO authenticated USING (public.user_has_min_level(0))';
    EXECUTE 'CREATE POLICY "update_companies" ON "public"."companies" AS PERMISSIVE FOR UPDATE TO authenticated USING (public.user_has_min_level(1)) WITH CHECK (public.user_has_min_level(1))';
  END IF;
END $$;
