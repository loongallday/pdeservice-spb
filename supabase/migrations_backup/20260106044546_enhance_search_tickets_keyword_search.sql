-- Enhance search_tickets to search across ticket details, site name, and company names (Thai/English)
-- The p_details parameter now searches: ticket.details, site.name, company.name_th, company.name_en
...
COMMENT ON FUNCTION search_tickets IS 'Comprehensive ticket search with server-side filtering. Text search (p_details) searches across: ticket.details, site.name, company.name_th, company.name_en';
