-- Drop and recreate search_tickets to filter by confirmed employees instead of requested employees
...
BEGIN
  ...
  WITH filtered_tickets AS (
    ...
    -- Changed: Use confirmed employees table instead of requested employees
    ...
    WHERE
      ...
      -- Employee filter (now uses confirmed employees)
...
-- Add comment
COMMENT ON FUNCTION search_tickets IS 'Search tickets with filters. Employee filter now searches confirmed employees (jct_ticket_employees_cf) instead of requested employees.';
